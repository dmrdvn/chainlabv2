...
export const navData: NavSectionProps['data'] = [
   ...
   */
  {
    ...
    items: [
      { title: 'Dashboard', path: paths.dashboard.root, icon: ICONS.dashboard },
      {
        ...
        icon: ICONS.course,
        children: [
          { title: 'All Projects', path: paths.dashboard.projects.root },
          { title: 'Create Project', path: paths.dashboard.projects.new },
        ],
      },
      {
   ...
   */
  {
    ...
    items: [
      { title: 'Online IDE', path: paths.ide.root, icon: ICONS.parameter },
