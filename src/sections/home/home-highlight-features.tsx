    ...
    >
      <MotionViewport>
        ...
        <Container>
          ...
          >
            <SectionTitle caption="Platform Capabilities" title="Key" txtGradient="features" />
...
const ITEMS = [
  {
    ...
    subtitle: 'Monitor and manage all your blockchain projects from a single, intuitive interface.',
    icon: 'solar:widget-2-bold-duotone',
    imgUrl: [
      `${CONFIG.assetsDir}/assets/images/home/dashboard1.png`,
      `${CONFIG.assetsDir}/assets/images/home/dashboard2.png`,
    ],
  },
  {
    title: 'Real-Time Collaboration',
    subtitle: 'Work together with your team in a Google Docs-like experience for code.',
    icon: 'solar:users-group-rounded-bold-duotone',
    imgUrl: [
      `${CONFIG.assetsDir}/assets/images/home/project1.png`,
      `${CONFIG.assetsDir}/assets/images/home/project-detail1.png`,
      `${CONFIG.assetsDir}/assets/images/home/project-detail2.png`,
      `${CONFIG.assetsDir}/assets/images/home/collabs1.png`,
      `${CONFIG.assetsDir}/assets/images/home/collabs2.png`,
    ],
  },
  {
    title: 'Smart Contract/Program Editor',
    subtitle:
      'Write, test and deploy smart contracts/programs with AI assistance and built-in security checks.',
    icon: 'solar:code-bold-duotone',
    imgUrl: [
      `${CONFIG.assetsDir}/assets/images/home/ide1.png`,
      `${CONFIG.assetsDir}/assets/images/home/ide2.png`,
      `${CONFIG.assetsDir}/assets/images/home/ide3.png`,
    ],
  },
];
    ...
    <Box sx={[{ flexShrink: 0 }, ...(Array.isArray(sx) ? sx : [sx])]} {...other}>
      <Box sx={{ mb: 6, gap: 2, display: 'flex' }}>
        ...
        <Stack spacing={2}>
          ...
          <Typography sx={{ color: 'text.primary' }}>{item.subtitle}</Typography>
        </Stack>
      </Box>
