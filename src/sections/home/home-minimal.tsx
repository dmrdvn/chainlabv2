...
export function HomeMinimal({ sx, ...other }: BoxProps) {
  const renderDescription = () => (
    <>
      <SectionTitle
        caption="Core Platform"
        title="What's in"
        txtGradient="ChainLab?"
    ...
    >
      ...
      >
        <Box
          component="img"
          alt="Home chart"
          src={`${CONFIG.assetsDir}/assets/images/home/about.webp`}
          sx={{ width: 720 }}
        />
      </Box>
    </Stack>
...
const ITEMS = [
  {
    ...
    description: 'AI-powered browser-based IDE with real-time collaboration and testing framework.',
  },
  {
    icon: `${CONFIG.assetsDir}/assets/icons/home/ic-design.svg`,
    title: 'Frontend Development',
    description: 'Seamless UI templates, component libraries, and cross-chain compatibility.',
  },
  {
    icon: `${CONFIG.assetsDir}/assets/icons/home/ic-development.svg`,
    title: 'Business Management',
    description:
      'Integrated tools for analytics, governance, token economics and community management.',
  },
];
